let quote = document.getElementById('error-quotes');

// This is an directory of easter eggs. You can provide your easter eggs as much as possible.
let easterEggs = [
  ...
  "Aku anak ITB kok 🙂",
  "Aku anak UGM kok 🙂",
  "laman ini belum teruji di ITB & IPB",
  window.location.href.split('/').pop() + " ini belum teruji di ITB & IPB",
  ...
  "fine!",
  "Download lagu DJ tiktok viral <a href='https://youtu.be/dQw4w9WgXcQ'>di sini</a>",
];

quote.innerHTML = easterEggs[Math.floor(Math.random() * easterEggs.length)];
